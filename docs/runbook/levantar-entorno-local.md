...
- **Configuración**: `Workspace/ciencuadras/config/platforms.json` por defecto (ver [onboarding](../onboarding/01-flujo-primera-interaccion.md) y [4-workspace](../architecture/4-workspace.md))
...
| "baseURL" o "smokePaths" undefined | Crear `Workspace/ciencuadras/config/platforms.json` desde `docs/templates/platforms.example.json` |
